...
function docs(){
  ...
  let intro = paragraph(docDiv, `I didn't meet a lot of developpers but a lot of them told me they used frameworks so they don't have to think about scoping.
   So i created Nightly as a concept. So the context in fact the scope`)
...
const docobj = {
  ...
  servers: [
    ...
    {
      name: 'nightly-prod',
      description: 'runs webpack build then serve the dist folder'
    }
  ]
}
